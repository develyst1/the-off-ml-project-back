...
const TROUBLESHOOTING_ACTION_PATTERN = /(?:ลอง|ตรวจสอบ|รีสตาร์ต|restart|ปิด|เปิด|ล้าง|clear|เปลี่ยน|ติดตั้ง|อัปเดต|update|ออกจากระบบ|เข้าสู่ระบบ|กด|ถอด|เสียบ|ตั้งค่า|เชื่อมต่อ|แนบ|ส่งภาพ|แจ้ง(?:รหัส|ข้อความผิดพลาด)|ติดต่อศูนย์)/iu;
